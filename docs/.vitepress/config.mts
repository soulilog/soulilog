...
export default defineConfig({
    ...
    head: [
        ...
        [ 'link', { rel: 'apple-touch-icon', sizes: '180x180', href: `${baseUri}/apple-touch-icon.png` } ],
        [ 'link', { rel: 'icon', type: 'image/png', sizes: '32x32', href: `${baseUri}/favicon-32x32.png` } ],
        [ 'link', { rel: 'icon', type: 'image/png', sizes: '16x16', href: `${baseUri}/favicon-16x16.png` } ],
        [ 'link', { rel: 'icon', sizes: 'any', href: '/favicon.ico' } ],

        [ 'link', { rel: 'sitemap', href: `${baseUri}/sitemap.xml` } ],
    ],
